...
import Constants, {Private} from '../settings/constants';
...
const getConfigToken = async (headers = {}) => {
  return {
...
export const apiGetToken = async (url, params = null, headers = {}) => {
  const _headers = await getConfigToken(headers);
  return apiGet(url, params, _headers);
};

export const apiPostToken = async (url, params = null, headers = {}) => {
  const _headers = await getConfigToken(headers);
