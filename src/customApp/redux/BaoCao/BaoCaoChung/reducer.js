...
const reducer = (state = initState, action) => {
  ...
  switch (type) {
    case actions.BAOCAOCHUNG_INIT_REQUEST:
      return {
        ...state,
        tableLoading: true,
      };
    case actions.BAOCAOCHUNG_INIT_REQUEST_SUCCESS:
      return {
        ...state,
    ...
    case actions.BAOCAOCHUNG_INIT_REQUEST_ERROR:
      return {
        ...state,
        ThongTinBaoCao: {},
        TotalRow: 0,
    ...
    case actions.BAOCAOCHUNGGET_INIT_REQUEST:
      return {
        ...state,
        DanhSachCoQuan: [],
      };
    case actions.BAOCAOCHUNGGET_INIT_REQUEST_SUCCESS:
      return {
        ...state,
        DanhSachCoQuan: payload.DanhSachCoQuan,
      };
    case actions.BAOCAOCHUNGGET_INIT_REQUEST_ERROR:
      return {
        ...state,
        DanhSachCoQuan: [],
      };
