...
import api from '../../../containers/NghiepVu/GiaoXacMinh/config';
...
function* getInitData({payload}) {
  try {
    ...
    yield put({
      type: actions.GIAOXACMINH_GET_INIT_REQUEST_SUCCESS,
      payload: {
    ...
    yield put({
      type: actions.GIAOXACMINH_GET_INIT_REQUEST_ERROR,
    });
  }
}
...
function* getDanhSachSoTiepCongDan({payload}) {
  try {
    ...
    // const danhsachcoquan = yield call(api.GetAllCoQuan);
    yield put({
      type: actions.GIAOXACMINH_GET_LIST_REQUEST_SUCCESS,
      payload: {
    ...
    yield put({
      type: actions.GIAOXACMINH_GET_LIST_REQUEST_ERROR,
    });
  }
}
...
export default function* rootSaga() {
  yield all([
    yield takeEvery(
      actions.GIAOXACMINH_GET_LIST_REQUEST,
