...
const apiUrl = {
  ...
  danhsachosotracuu: server.v2Url + 'TraCuu/DanhSachHoSoDuocTraCuu',
  danhsachlichsutracuu: server.v2Url + 'TraCuu/LichSuTraCuu',
...
// lay danh sach
const api = {
  DanhSachHoSoTraCuu: (param) => {
    return apiGetAuth(apiUrl.danhsachosotracuu, {
      ...param,
      PageNumber: param.PageNumber ? param.PageNumber : 1,
      PageSize: param.PageSize ? param.PageSize : getDefaultPageSize(),
    });
  },
  DanhSachLichSuTraCuu: (param) => {
    return apiGetAuth(apiUrl.danhsachlichsutracuu, {
      ...param,
      PageNumber: param.PageNumber ? param.PageNumber : 1,
      PageSize: param.PageSize ? param.PageSize : getDefaultPageSize(),
    });
