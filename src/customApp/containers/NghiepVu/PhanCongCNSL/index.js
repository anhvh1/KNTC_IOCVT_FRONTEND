...
import actions from "../../../redux/NghiepVu/PhanCongCNSL/actions";
...
const PhanCongCNSL = (props) => {
  document.title = "Phân công cập nhật số liệu";
  ...
  const renderThaoTac = (record) => {
    return (
      <div className={"action-btn"}>
        <Tooltip title={"Phân công cập nhật "}>
          <svg
            onClick={() => {
...
export default connect(mapStateToProps, actions)(PhanCongCNSL);
