...
const apiUrl = {
  danhsachxulydon: server.v2Url + 'GiaiQuyetDon/GetListPaging',
  chitietxacminhnoidungdon: server.v2Url + 'GiaiQuyetDon/GetByID',
  giaoxacminh: server.v2Url + 'GiaiQuyetDon/GiaoXacMinh',
  suadonthu: server.v2Url + 'GiaiQuyetDon/GiaoXacMinh',
  ...
  getnguoidungbycoquanid: server.v2Url + 'HeThongCanBo/GetAllCanBoByCoQuanID',
  rutdon: server.v2Url + 'GiaiQuyetDon/RutDon',
  giahanthoigianxacminh: server.v2Url + 'GiaiQuyetDon/GiaHanThoiGianXacMinh',
  capnhapdoandoxacminh: server.v2Url + 'GiaiQuyetDon/CapNhapDoanToXacMinh',
};
// lay danh sach
const api = {
  ...
  GetNguoiDungByCoQuanID: (param) => {
    return apiGetAuth(apiUrl.getnguoidungbycoquanid, {
      ...param,
    });
  },
  ...
  CapNhapDoanToXacMinh: (param) => {
    return apiPostAuth(apiUrl.capnhapdoandoxacminh, param);
  },
  ...
  GiaHanThoiGianXacMinh: (param) => {
    return apiPostAuth(apiUrl.giahanthoigianxacminh, param);
  },
