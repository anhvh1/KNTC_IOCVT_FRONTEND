...
const apiUrl = {
  // danhsachketquatranhchap: server.v2Url + 'XuLyDon/GetListPaging',
  danhsachketquatranhchap: server.v2Url + 'KetQuaTranhChap/GetListPaging',
  chitietketqua: server.v2Url + 'KetQuaTranhChap/GetByID',
  save: server.v2Url + 'KetQuaTranhChap/Save',
...
// lay danh sach
const api = {
  DanhSachKetQuaTranhChap: (param) => {
    return apiGetAuth(apiUrl.danhsachketquatranhchap, {
      ...param,
  ...
  ChiTietKetQua: (param) => {
    return apiGetAuth(apiUrl.chitietketqua, {
      ...param,
    });
  },
  TrinhDuyet: (param) => {
  ...
  Save: (param) => {
    return apiPostAuth(apiUrl.save, param);
  },
