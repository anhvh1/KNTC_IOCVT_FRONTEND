...
export const apiUrl = {
  danhsachTaoCuoc: server.v2Url + "TaoCuocThanhTra/GetListPaging",
  danhsachCanBo:
  ...
  suaTaoCuocDotXuat:
    server.v2Url + "TaoCuocThanhTra/Update_CuocThanhTraDotXuat",
  themTaoCuocDotXuat:
    server.v2Url + "TaoCuocThanhTra/Insert_CuocThanhTraDotXuat",
  chitietTaoCuoc: server.v2Url + "TaoCuocThanhTra/GetByID",
  chitietPhanLoai: server.v2Url + "PhanLoaiThanhTra/GetById",
  ...
  Listagency: server.v2Url + "CoQuan/GetCoQuanOrDoanhNghiepByPhanLoai_DX",
  deleteCuocDotXuat:
    server.v2Url + "TaoCuocThanhTra/Delete_CuocThanhTraDotXuat",
  HuyCuoc: server.v2Url + "TaoCuocThanhTra/HuyCuocThanhTra",
  ...
  danhSachListLinhVuc: server.v2Url + "PhanLoaiThanhTra/GetLinhVuc",
...
const api = {
  ...
  danhSachListLinhVuc: (param) => {
    return apiGetAuth(apiUrl.danhSachListLinhVuc, {
      ...param,
    });
  },
  deleteCuocDotXuat: (cuocThanhTraID) => {
    return apiPostAuth(
      `${apiUrl.deleteCuocDotXuat}?cuocThanhTraID=${cuocThanhTraID}`
    );
  },
  BoChuyenCuoc: (cuocThanhTraID) => {
    return apiPostAuth(
      `${apiUrl.BoChuyenCuoc}?cuocThanhTraID=${cuocThanhTraID}`
    );
  },
  ...
  danhsachCanBo: (type) => {
    return apiGetAuth(`${apiUrl.danhsachCanBo}?type=${type}`);
  },

  chiTietTaoCuoc: (cuocThanhTraID) => {
    return apiGetAuth(
      `${apiUrl.chitietTaoCuoc}?cuocThanhTraID=${cuocThanhTraID}`
    );
  },
  chitietPhanLoai: (id) => {
    return apiGetAuth(`${apiUrl.chitietPhanLoai}?id=${id}`);
  },
  suaTaoCuoc: (param) => {
