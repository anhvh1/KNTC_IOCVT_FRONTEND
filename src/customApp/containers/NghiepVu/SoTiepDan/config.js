...
const apiUrl = {
  ...
  capnhapsodonthutheonam: server.v2Url + 'TiepDan/CapNhapSoDonThuTheoNam',
  rutdon: server.v2Url + 'RutDon_V2/Insert',
  chuyendonsangtiepnhandon: server.v2Url + 'TiepDan/ChuyenDonSangTiepNhanDon',
...
const api = {
  ...
  UpdateSoDonThuTheoNam: (params) => {
    return apiPostAuth(apiUrl.capnhapsodonthutheonam, params);
  },
  GetSTTHoSo: (params) => {
  ...
  // ChuyenDonSangTiepNhanDon: (param) => {
  //   return apiPostAuth(apiUrl.chuyendonsangtiepnhandon, param);
  // },
  ChuyenDonSangTiepNhanDon: (xuLyDonIDIdS, donThuIDIDs, param) => {
    const url = `${apiUrl.chuyendonsangtiepnhandon}?xuLyDonIDIdS=${xuLyDonIDIdS}&donThuIDIDs=${donThuIDIDs}`;
