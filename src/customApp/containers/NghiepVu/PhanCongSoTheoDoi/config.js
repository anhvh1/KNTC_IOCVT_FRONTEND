...
export const apiUrl = {
  danhsachTaoCuoc: server.v2Url + 'PhanCongSoTheoDoi/GetListPaging',
  ...
  chitietTaoCuoc: server.v2Url + 'PhanCongSoTheoDoi/GetThanhVienThanhTra',
  PhanCongThanhVien: server.v2Url + 'PhanCongSoTheoDoi/GetByCuocThanhTraID',
  ...
  HuyCuoc: server.v2Url + 'PhanCongSoTheoDoi/PhanCongSoTheoDoi',
