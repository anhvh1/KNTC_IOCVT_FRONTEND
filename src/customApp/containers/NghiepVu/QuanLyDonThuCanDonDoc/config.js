...
const apiUrl = {
  danhsachdonthucandondoc: server.v2Url + 'QuanLyDonThuCanDonDoc/GetListPaging',
  // danhsachdonthucandondoc: server.v2Url + 'XuLyDon/GetListPaging',
  chitietdonthu: server.v2Url + 'XuLyDon/GetByID',
  capnhatvbdondoc: server.v2Url + 'QuanLyDonThuCanDonDoc/RaVanBanDonDoc',
...
// lay danh sach
const api = {
  DanhSachDonThuCanDonDoc: (param) => {
    return apiGetAuth(apiUrl.danhsachdonthucandondoc, {
      ...param,
