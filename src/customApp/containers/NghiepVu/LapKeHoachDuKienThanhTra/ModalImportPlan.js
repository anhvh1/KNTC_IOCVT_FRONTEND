...
const ModalImportPlan = ({
  ...
  const ACCEPT_FILE_UPLOAD_2 = data_config?.ACCEPT_FILE_UPLOAD_2;
    ...
    form
      ...
      .then((values) => {
        ...
        values.NamThanhTra = values.NamThanhTra
          ? dayjs(values.NamThanhTra).format("YYYY")
          : null;
    ...
    >
      <Wrapper>
        <Form form={form} layout="vertical">
          ...
          <hr />
          <Item>
            <div className="dowload-btns" style={{ marginTop: 15 }}>
              <Button
                type="primary"
                ...
                className="btn"
              >
                Mẫu kế hoạch TTKT đơn vị Hành chính, sự nghiệp
              </Button>
              <p>
                (dùng cho loại đối tượng là{" "}
                <span>Đơn vị hành chính, sự nghiệp</span>)
              </p>
            </div>
            <div className="dowload-btns">
              <Button
                ...
                className="btn"
              >
                Mẫu kế hoạch TTKT doanh nghiệp
              </Button>
              <p>
