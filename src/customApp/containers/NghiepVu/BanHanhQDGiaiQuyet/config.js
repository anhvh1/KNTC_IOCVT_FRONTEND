...
const apiUrl = {
  danhsachqdthihanh: server.v2Url + 'XuLyDon/GetListPaging',
  chitietdonthu: server.v2Url + 'XuLyDon/GetByID',
  banhanh: server.v2Url + 'XuLyDon/Save',
  capnhatbanhanh: server.v2Url + 'XuLyDon/Save',
...
// lay danh sach
const api = {
  DanhSachQDThihanh: (param) => {
    return apiGetAuth(apiUrl.danhsachqdthihanh, {
      ...param,
