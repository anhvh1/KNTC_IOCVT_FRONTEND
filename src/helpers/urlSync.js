...
export function getDeufaultOpenSideKey() {
  const preOpenKeys = localStorage.getItem('openKeySideBar');
  if (preOpenKeys) {
    const parsePreOpenKey = JSON.parse(preOpenKeys);
    return parsePreOpenKey;
  }
}
